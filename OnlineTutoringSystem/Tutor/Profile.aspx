                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlGender" Display="Dynamic" ErrorMessage="Gender is required." CssClass="text-danger" InitialValue="" ValidationGroup="ProfileInfoValidation" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDob" Display="Dynamic" ErrorMessage="Date Of Birth is required." CssClass="text-danger" InitialValue="" ValidationGroup="ProfileInfoValidation" />
                                        </div>
                                    </div>
