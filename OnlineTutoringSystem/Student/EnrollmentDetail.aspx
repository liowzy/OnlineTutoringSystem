                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="text-right">
                                    <asp:Button ID="btnRateTutorAndCourse" runat="server" class="btn btn-primary" style="background-color: #FF6636; border-color: #FF6636;" Text="Rate Tutor and Course" OnClick="btnRateTutorAndCourse_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
