                        ...
                        <div class="col-9 mb-4 mx-auto">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <small class="text-muted"><i class="bi bi-clipboard-check"></i><%# Eval("schedule_status") %></small>
                                    <asp:Button runat="server" CssClass="btn btn-danger btn-sm float-end"
                                        Text="Delete" OnClick="DeleteSchedule_Click" CommandArgument='<%# Eval("schedule_id") %>'/>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
